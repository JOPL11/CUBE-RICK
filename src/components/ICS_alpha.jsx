...
const initialCubeTexts = [
  { topLeftText: "NEWS", bottomRightText: "LATEST", description: "Bear with us while we currently migrate to this new Next.js + React 3 Fiber format - there might be some large and small corrections. As for the text, it'll definitely be updated. Until its done, you can check out the old html5 site.", externalUrl: "https://www.jopl.de/2/index2.html" },
  { topLeftText: "ABOUT", 
...
{ 
  ...
  description: `WARNING: This link leads to an experimental playground.
  ...
  { topLeftText: "C4D + AE", bottomRightText: "2D / 3D MOTION DESIGN", description: `Motion skills include 3D Modeling, 2D/3D Animation, Cinema4D, Blender. 
    ...
    Opens in a new window.`, videoUrl: "https://www.jopl.de/2/new/2025Reel_B.mp4" },
  { topLeftText: `3D MOTION`, bottomRightText: "SHORT REEL", description: `Showreel showing pure 3D Motion-design.
  ...
  { topLeftText: `BLENDER + R3F`, bottomRightText: "EXTENDED REEL", description: `Showreel showing 3D Motion-design, 2D Motion Design, 2D Text animation,  2D Character Animation in 3D Environments, IK Animation, basically the full sandwich, sort of. 
  ...
  { topLeftText: `XR/3D DEVELOPMENT`, bottomRightText: "INTERACTIVE", description: `WARNING: This link leads to an experimental playground. A collection of personal experiments showcasing:

    - Interactive 3D WebGL Experiments
    - WebXR Experiments for use in the Quest3S headset.(Which is awesome by the way.)
    
    Pure creative play - no commercial constraints. Not for the corporately obsessed.`, externalUrl: "https://www.jopl.de/2/experiments.html" },
...
Ich entwickle und setze visuelle Konzepte um – von Originaldesigns bis zur Verfeinerung bestehender CI/CD-Systeme – mit Expertise in Animation und interaktiver Entwicklung. Mehr als 3 Jahre Führungserfahrung.

15+ Jahre Zusammenarbeit mit Agenturen, Inhouse-Teams und Startups – immer im Spannungsfeld zwischen Innovation und Markenkonformität, um visuelle Konsistenz über alle Deliverables hinweg zu gewährleisten.
...
{ topLeftText: "VISUALIZIERUNG", bottomRightText: "GALERIE", description: `WARNUNG: Dieser Link führt zu einem experimentellen Spielplatz.
  Eine Sammlung persönlicher Experimente, die zeigen:
  
      3D-Modellierung/Rendering
  
      Nachbearbeitung von VFX
  
      Free-Jazz-inspirierte Motion Design
  
  Reine kreative Spielerei – frei von kommerziellen Zwängen.
  Nichts für Corporate-Fanatiker.`, images: [
      "/images/gallery/jan-peiro-bbdashboard-master-8.jpg",
      "/images/gallery/jan-peiro-bbdashboard-master-9.jpg",
      "/images/gallery/jan-peiro-bbdashboard-master-10.jpg",
      "/images/gallery/jan-peiro-bbdashboard-master-11.jpg",
      "/images/gallery/jan-peiro-bbdashboard-master-12.jpg"
    ] },
...
{ topLeftText: "VISUALISATIONS", bottomRightText: "GALERIE", description: `AVERTISSEMENT : Ce lien mène à un terrain de jeu expérimental.
  Une collection d'expériences personnelles démontrant :
  
      Modélisation et rendu 3D
  
      Post-production VFX
  
      Motion Design inspiré du Free Jazz
  
  Pures explorations créatives – libérées des contraintes commerciales.
  Rien à voir avec le corporatisme.` },
...
const SINGLECUBE_SIZE = 6 // Size of each cube
...
function CubeLayout({ onCubeSelect }) {
  ...
  const getCubeColor = (index) => {
    return index % 2 === 0 ? "#3d3d3d" : "#3d3d3d"
  }
  ...
  if (isMobile) {
    ...
    return (
      <>
          {/* Row Zero */}
          <group position={[0, CUBE_Y_POSITION + 1.0, -CUBE_SPACING * 3.95]}>
...
export default function InteractiveCubesScene() {
  ...
  const [activeLanguage, setActiveLanguage] = useState('en'); // default to English
  const [introComplete, setIntroComplete] = useState(false); // Add this line
